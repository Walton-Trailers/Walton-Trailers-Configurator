...
export default function Configurator() {
  ...
  // Shared submission flag — used by the live "Request a Quote" dialog
  // (showQuoteModal) further down. Custom-quote flow is gone but this
  // still drives the regular quote-request modal.
                  ...
                  <div className="flex items-center justify-between gap-3">
                    ...
                    {isDealerLoggedIn ? (
                      ...
                      <Button
                        ...
                        className="bg-[#b7a380] hover:bg-[#9e8c6d] text-white px-3 md:px-4 py-2 md:py-2.5 text-xs md:text-sm flex-shrink-0 whitespace-nowrap"
                      >
                        Request A Quote
                      </Button>
                    )}
